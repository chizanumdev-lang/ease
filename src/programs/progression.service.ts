...
export class ProgressionService {
  ...
  private readonly GOAL_VARIANT_MAP = {
    mindfulness: {
      phase1_seed: { title: 'Seed of Quiet', subtitle: "You're planting the first seeds of peace. It's okay to start small." },
      phase2_sprout: { title: 'Gentle Sprout', subtitle: "Your mind is starting to settle. You're finding small moments of calm." },
      phase3_sapling: { title: 'Steady Calm', subtitle: "You're handling stress much better now. Your roots of peace are deep." },
      phase4_tree: { title: 'Sheltering Tree', subtitle: "Your inner peace is strong enough to protect you from any storm." },
      phase5_wisdom: { title: 'Radiant Serenity', subtitle: "You carry a sense of peace wherever you go. You feel light and free." },
      phase6_ancient: { title: 'Master of Stillness', subtitle: "You are perfectly at home in the present moment. Nothing can shake you." },
    },
    focus: {
      phase1_seed: { title: 'Seed of Purpose', subtitle: "You're setting your intention. Clarity starts with a single step." },
      phase2_sprout: { title: 'Growing Intent', subtitle: "Your focus is sharpening. You're getting better at staying on track." },
      phase3_sapling: { title: 'Rooted Discipline', subtitle: "You've built a solid foundation. Work feels easier and more natural." },
      phase4_tree: { title: 'Broad Vision', subtitle: "You can see the big picture clearly. Your output is growing every day." },
      phase5_wisdom: { title: 'Peak Performance', subtitle: "You're in the flow. Your mind is a powerful tool for creation." },
      phase6_ancient: { title: 'Infinite Creator', subtitle: "You've mastered your time and energy. You can achieve anything." },
    },
    energy: {
      phase1_seed: { title: 'Seed of Vitality', subtitle: "You're waking up your inner fire. Every small movement counts." },
      phase2_sprout: { title: 'Rising Spark', subtitle: "You're feeling more alert. Your energy levels are starting to stabilize." },
      phase3_sapling: { title: 'Power Sapling', subtitle: "You have the fuel to get through your day. You feel strong and ready." },
      phase4_tree: { title: 'Radiant Glow', subtitle: "Your energy is contagious. You're moving through life with real momentum." },
      phase5_wisdom: { title: 'Peak Vitality', subtitle: "You're at your physical and mental best. You feel like you can take on the world." },
      phase6_ancient: { title: 'Infinite Source', subtitle: "Your energy is a limitless spring. You are fully alive and unstoppable." },
    },
    balance: {
      phase1_seed: { title: 'Seed of Harmony', subtitle: "You're finding your center. Balance begins with a single choice." },
      phase2_sprout: { title: 'Shifting Weight', subtitle: "You're learning to juggle life better. Things are starting to align." },
      phase3_sapling: { title: 'Rooted Center', subtitle: "You've found a steady rhythm. You feel more in control of your time." },
      phase4_tree: { title: 'Balanced Reach', subtitle: "You're thriving in all areas of life. You've found the sweet spot." },
      phase5_wisdom: { title: 'Effortless Flow', subtitle: "Everything is in its right place. You're living with ease and grace." },
      phase6_ancient: { title: 'Master of Life', subtitle: "You've achieved perfect harmony. You are the conductor of your own life." },
    }
  };
  ...
  getLevelEntailment(level: number, goalCategory?: string): string {
    ...
    const entailments = (normalizedCategory && this.LEVEL_ENTAILMENTS[normalizedCategory as keyof typeof this.LEVEL_ENTAILMENTS]) || this.LEVEL_ENTAILMENTS.mindfulness;
    ...
    const phase = this.PHASES.find((p) => level >= p.minLevel && level <= p.maxLevel) || this.PHASES[this.PHASES.length - 1];
  ...
  getProgression(totalXp: number, goalCategory?: string): ProgressionData {
    ...
    const normalizedCategory = goalCategory?.toLowerCase();
    const variant = normalizedCategory ? this.GOAL_VARIANT_MAP[normalizedCategory as keyof typeof this.GOAL_VARIANT_MAP] : undefined;
