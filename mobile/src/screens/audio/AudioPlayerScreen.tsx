    ...
    return (
      <View
        style={[
          styles.container,
          {
            backgroundColor: isDark ? '#0a0812' : colors.background,
      ...
      >
        ...
        >
          The audio generation is not completed or the URL is invalid.
        </Text>
      ...
      <View style={styles.pulseContainer}>
        ...
        <View
          style={[
            ...
            { borderColor: `${colors.primary}33`, shadowColor: colors.primary },
          ]}
        >
          <Image
            source={{
        ...
        <View style={styles.trackDetails}>
          ...
          <Text style={[styles.trackSubtitle, { color: colors.textMuted }]}>
            Ease Audio • 432Hz Healing Frequency
          </Text>
        </View>
      </View>
        ...
        <View style={styles.actionRow}>
          ...
          >
            ...
            <Slider
              ...
              maximumValue={1}
              value={volume}
              onValueChange={(val) => void setVolume(val)}
          ...
          >
            ...
            <Text style={[styles.timerBadgeText, { color: colors.primary }]}>
              {stopTimer ? `${stopTimer}M` : 'OFF'}
            </Text>
          </TouchableOpacity>
        </View>
            ...
            >
              <Text
                style={[
                  styles.presetText,
                  { color: colors.textMuted },
                  stopTimer === opt.value && { color: colors.primary },
                ]}
              >
                {opt.label}
              </Text>
