import { Controller, Patch, Param, Body, UseGuards, Post, UseInterceptors, UploadedFile, Query, Logger } from '@nestjs/common';
...
export class TasksController {
    ...
    async gradeVocal(
        ...
        try {
            ...
            return await this.aiService.gradeVocalPerformance(file.buffer, targetScript, locale, file.mimetype);
        } catch (error) {
