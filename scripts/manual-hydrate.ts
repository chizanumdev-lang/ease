...
async function bootstrap() {
    ...
    try {
        ...
        console.log(`Found Day 1 with ID (index-based lookup might be needed, using dayNumber)`);
        ...
        const dayRecord = await dayPlanRepo.findOne({ where: { programId, dayNumber: 1 } });
        ...
        await programsService.hydrateDay(dayRecord.id, goalText, params);
